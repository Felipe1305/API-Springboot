...
-- Dump completed on 2021-06-18 22:52:31
...
-- Dump completed on 2021-06-18 22:52:32
...
CREATE TABLE `cliente` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cpfou_cnpj` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2021-06-18 22:52:30
-- MariaDB dump 10.19  Distrib 10.4.18-MariaDB, for Win64 (AMD64)
--
-- Host: 127.0.0.1    Database: curso_spring
-- ------------------------------------------------------
...
-- Dump completed on 2021-06-18 22:52:29
...
CREATE TABLE `pedido` (
  ...
  `cliente_id` int(11) DEFAULT NULL,
  `emdereco_entrega_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK30s8j2ktpay6of18lbyqn3632` (`cliente_id`),
  KEY `FKnpbsxkhw9va134plj2hsq7sh4` (`emdereco_entrega_id`),
  CONSTRAINT `FK30s8j2ktpay6of18lbyqn3632` FOREIGN KEY (`cliente_id`) REFERENCES `cliente` (`id`),
  CONSTRAINT `FKnpbsxkhw9va134plj2hsq7sh4` FOREIGN KEY (`emdereco_entrega_id`) REFERENCES `endereco` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `produto` VALUES (1,'Computador',2000),(2,'Impressora',800),(3,'Mouse',80),(4,'Mesa de Escritório',80),(5,'Toalha',80),(6,'Colcha',80),(7,'Tv true color',80),(8,'Roçadeira',80),(9,'Abajour',80),(10,'Pendente',80),(11,'Shampoo',90);
